...
while True:
    ...
    seconds_remaining = 30 - elapsed_time
    ...
    if elapsed_time >= 30:
        ...
        if total_cpr_count < 30:
            efficiency = "Inefficient CPR"
        elif 30 <= total_cpr_count <= 35:
            efficiency = "Effective CPR"
        else:
            efficiency = "Vigorous CPR"

        results = {
            "total_cpr_count": total_cpr_count,
            "good_compress_count": good_compress_count,
            "cpr_efficiency": efficiency
        }
